...
export default function CreateBetPage() {
  ...
  const addOption = () => {
    setOptions([...options, { label: "", odds: 1 }]);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">🎲 Criar Bet</h1>
        ...
        {/* Formulário */}
        <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
          {error && (
              ...
              {options.map((option, index) => (
                <div key={index} className="flex gap-2">
                  ...
                  <input
                    ...
                    className="w-24 px-4 py-2 bg-white/5 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                    placeholder="Odds"
                    step="0.1"
                    min="1"
                  />
