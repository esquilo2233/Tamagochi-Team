...
export default function CenasPage() {
  ...
  async function handleResetStats() {
    if (!hasAccess) return;
    if (
      !confirm("Tens a certeza que queres resetar todos os stats do Samurai?")
    )
      return;
  ...
  async function handleImportItems(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      if (!Array.isArray(items)) {
        setError("Ficheiro inválido. Deve ser um array de itens em JSON.");
  ...
  return (
    <main style={{ padding: 24, maxWidth: 520, margin: "0 auto" }}>
      {checkingAccess ? (
        ...
        >
          Sem permissão para aceder ao painel Cenas. Apenas pessoas com role{" "}
          <strong>admin</strong> ou <strong>gestor</strong> podem entrar.
        </div>
      ) : null}
      ...
      {hasAccess && (
        <>
          ...
          <p style={{ color: "var(--muted)", marginBottom: 16 }}>
            Menu rápido para mexer em pessoas, itens da loja e avatar do
            Samurai.
          </p>
          ...
          <p style={{ color: "var(--muted)", marginBottom: 24 }}>
            Escolha uma imagem para ser o avatar do boneco na página principal.
            Formatos: JPEG, PNG, GIF, WebP ou SVG (máx. 5MB).
          </p>
          ...
          {success && (
            ...
            >
              Avatar atualizado. O boneco na página principal passa a usar esta
              imagem.
            </div>
          )}
          ...
          >
            ...
            <p style={{ color: "var(--muted)", marginTop: 0 }}>
              Reseta todos os stats do Samurai para 100 (Fome, Energia,
              Felicidade, Higiene, Vida).
            </p>
            <button
          ...
          >
            ...
            <p style={{ color: "var(--muted)", marginTop: 0 }}>
              Aqui podes ajustar as quedas dos status por minuto e a janela de
              horário com decadência reduzida (hora de Portugal).
            </p>
            ...
            >
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      hungerDecayPerMinute: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      energyDecayPerMinute: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      happinessDecayPerMinute: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      hygieneDecayPerMinute: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={decayConfig.lifeDecayWhenHungerZeroPerMinute}
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      lifeDecayWhenHungerZeroPerMinute: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={decayConfig.lifeDecayWhenEnergyZeroPerMinute}
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      lifeDecayWhenEnergyZeroPerMinute: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={decayConfig.lifeDecayWhenHygieneZeroPerMinute}
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      lifeDecayWhenHygieneZeroPerMinute: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={decayConfig.lowAttentionDecayMultiplier}
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      lowAttentionDecayMultiplier: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      lowAttentionStartHour: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      lowAttentionEndHour: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setDecayConfig({
                      ...decayConfig,
                      lowAttentionEnabled: e.target.checked,
                    })
                  }
                />
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: 8,
                  border: "none",
                  background: savingConfig ? "#9ca3af" : "#16a34a",
                  color: "white",
          ...
          >
            ...
            <p style={{ color: "var(--muted)", marginTop: 0 }}>
              Controla quantas moedas são dadas ao ganhar/perder cada minijogo e
              também os ganhos na companhia.
            </p>
            ...
            >
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      clickrushWinCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      clickrushLoseCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              >
                <span>Click Rush: cliques para considerar vitória</span>
                <input
                  type="number"
                  min={0}
                  value={rewardsConfig.clickrushWinScoreThreshold}
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      clickrushWinScoreThreshold: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      tictactoeWinCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      tictactoeLoseCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      chessWinCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      chessLoseCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      connect4WinCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      connect4LoseCoins: Number(e.target.value),
                    })
                  }
                />
              </label>
              ...
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      companionTickMinutes: Number(e.target.value),
                    })
                  }
                />
              </label>
              <label style={{ display: "grid", gap: 4 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRewardsConfig({
                      ...rewardsConfig,
                      companionCoinsPerTick: Number(e.target.value),
                    })
                  }
                />
              </label>
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: 8,
                  border: "none",
                  background: savingConfig ? "#9ca3af" : "#2563eb",
                  color: "white",
                  cursor: savingConfig ? "not-allowed" : "pointer",
                  fontWeight: 600,
                }}
