...
export default function Shop() {
    ...
    const [sessionPerson, setSessionPerson] = useState<{
        id: number;
        name: string;
        coins: number;
    } | null>(null);
    ...
    async function buy(itemId: number) {
        if (!hasSession || !selectedPersonId) {
            setNotice("Entre com o seu código para comprar");
                        ...
                        >
                            <button
                                ...
                                style={{
                                    padding: "8px 12px",
                                    borderRadius: 6,
                                    background: hasSession ? "#0984e3" : "#ccc",
                                    color: "white",
                                    border: "none",
                                    cursor: hasSession
                                        ? "pointer"
